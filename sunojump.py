#!/usr/bin/env python3
"""SunoJump v1.3.0 - Audio fingerprint masking tool for Suno AI"""
...
class MainWindow(QMainWindow):
    ...
    def _build_preview(self):
        ...
        lay.addWidget(self.btn_render_preview)
    ...
    def _set_processing_ui(self, processing):
        ...
        # Preview is mutually exclusive with batch processing
        if _MULTIMEDIA_OK:
            self.btn_render_preview.setEnabled(
                (not processing) and self._current_selected_item() is not None,
            )
    ...
    def _set_preview_running_ui(self, running):
        ...
        # Block full-batch processing while a preview render is in flight
    ...
    def _update_preview_ui(self):
        ...
        self.btn_render_preview.setEnabled(
            item is not None and not preview_worker_running and not batch_running,
        )
